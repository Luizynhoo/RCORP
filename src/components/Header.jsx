      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            >
              <Link to="/marcas" className={cn(linkClasses('/marcas'), "flex items-center space-x-1")}>
              ...
              <AnimatePresence>
                {isMegaMenuOpen && (
                  <motion.div
                    className="fixed top-[80px] left-0 w-screen bg-white shadow-lg border-b border-gray-200 rounded-b-lg z-40"
